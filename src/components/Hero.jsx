...
import profilePic from "./profile.png"; // ✅ Correct path

const Hero = () => {
  return (
    <section className="relative min-h-screen px-6 sm:px-8 md:px-32 py-20 bg-[#0a192f]/60 backdrop-blur-sm text-[#ccd6f6] flex flex-col-reverse md:flex-row items-center justify-between gap-12">
      ...
      {/* Down Arrow */}
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-6 sm:bottom-10 animate-bounce text-[#64ffda]">
        <a href="#about" className="flex flex-col items-center hover:text-white transition">
          <FaArrowDown size={22} />
        </a>
      </div>
    </section>
